...
const UUID = process.env.UUID || '30aa6e46-b873-475d-7bc03599e7b0';  // 在不同的平台运行了v1哪吒请修改UUID,否则会覆盖
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'tlu.6is.dpdns.org';           // argo固定隧道域名,留空即使用临时隧道
